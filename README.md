...
**62 个 MCP 工具** · 基于智能论 v3.2 的条件论知识系统 · 零外部依赖（D-005）

### 核心能力
- **信息分层处理**：智慧之书图谱自处理 → LLM 兜底 → 白箱校验（锚定/图谱外/警告）
- **条件化知识**：141 张知识卡，每条带条件空间声明（在什么条件下成立）+ 克制条款
...
### 基准
- 110 题知识测试：80% 正确率（5.71MB 图谱 vs qwen0.5B 975MB 的 17.6）
- 1000 条日常对话：简单类自处理 83.8%，情感 100% 自处理
