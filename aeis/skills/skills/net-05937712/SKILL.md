...
name: net-05937712
description: >-
  NTP同步 / 网络-NTP同步 / NTP——时间偏移与往返 / NTP 同步 / offset 时间偏 / 客户端 t1 发送 / 服务器 t2 收到。用户提到这些词时使用本技能。
...
metadata:
  ...
  kccs:
    trigger_words: ["NTP同步", "网络-NTP同步", "NTP——时间偏移与往返", "NTP 同步", "offset 时间偏", "客户端 t1 发送", "服务器 t2 收到"]
