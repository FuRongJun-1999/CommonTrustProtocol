...
description: >-
  捕获更新 / 闭包-捕获更新 / Python nonlo / nonlocal 语 / 闭包修改捕获变量（非 / 递增 / 修改外层捕获变量并返 / 演示。用户提到这些词时使用本技能。
...
metadata:
  ...
  kccs:
    trigger_words: ["捕获更新", "闭包-捕获更新", "Python nonlo", "nonlocal 语", "闭包修改捕获变量（非", "递增", "修改外层捕获变量并返", "演示"]
    when: "参数 输入 合法"
    sub: []
