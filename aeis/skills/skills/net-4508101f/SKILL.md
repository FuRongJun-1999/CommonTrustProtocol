...
name: net-4508101f
description: >-
  蜂群中继 / 网络-蜂群中继 / 蜂群网络——消息经邻居递 / seen 防回环 / 蜂群消息 / 源节点 → 邻居递归 / 递归中继 / 未访问则记录并继续转。用户提到这些词时使用本技能。
...
metadata:
  ...
  kccs:
    trigger_words: ["蜂群中继", "网络-蜂群中继", "蜂群网络——消息经邻居递", "seen 防回环", "蜂群消息", "源节点 → 邻居递归", "递归中继", "未访问则记录并继续转"]
