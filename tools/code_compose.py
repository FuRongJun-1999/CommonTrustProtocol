...
DOMAIN_KEYWORDS = {
    ...
    "os": ["进程", "调度", "内存", "文件系统", "路径解析", "管道", "IPC",
           ...
           "进程生命周期", "磁盘调度", "写时复制快照", "磨损均衡", "强制访问控制", "系统调用过滤", "加密文件系统", "服务管理", "日志轮转", "定时任务", "配置管理", "权限提升", "环境变量", "网络接口", "设备驱动", "电源管理", "文件压缩", "存储池", "文件版本", "条件变量", "自旋锁", "时间片轮转", "优先级继承", "内存池", "稀疏文件", "碎片整理", "段式管理", "时钟节拍", "孤儿进程", "内存碎片", "多核均衡"],
