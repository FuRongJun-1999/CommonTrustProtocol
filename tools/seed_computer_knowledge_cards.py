...
NODES = [
    ...
    ("kp_card_degdist",
     "图的度分布",
     "计算机科学知识点内容（人话接口）", "计算机",
     "度分布统计图中每个节点的度（相连边数）的出现频率：遍历所有节点数出邻居数，"
     "汇总成「度值 → 节点数」的分布表——无向图度=边端点计数，有向图分入度出度。",
     ["问度分布", "图的度怎么统计", "问节点度数分布"],
     ["问最短路径算法", "问图着色"],
     "atomic", "",
     "度分布 = 遍历每个节点数邻居边数，汇总成度值到节点数的频率统计。"),
    ("kp_card_ins",
     "插入排序",
     "计算机科学知识点内容（人话接口）", "计算机",
     "插入排序：逐个取出元素，插入到前方已有序区间的正确位置——像整理手牌，"
     "已处理部分始终保持有序；小规模或近有序数据上效率很好。",
     ["问插入排序", "排序的基本思想", "问插入排序思想"],
     ["问快速排序实现", "问排序算法复杂度证明"],
     "atomic", "",
     "插入排序 = 逐个取元素插入前方有序区间的正确位置——像整理手牌保持有序。"),
    ("kp_card_ws",
     "工作窃取",
     "计算机科学知识点内容（人话接口）", "计算机",
