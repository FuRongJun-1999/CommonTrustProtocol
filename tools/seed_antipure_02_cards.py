# -*- coding: utf-8 -*-
"""seed_antipure_02_cards.py · 知识域拓展批次（幂等）

反纯巡检02：微生物学-细菌与病毒/光学-凸透镜凹透镜/心理学-记忆类型/地理学-中国河流，
KCCS 四要素+题干原句触发词。
"""
import json
import os
...
NODES = [
    ("kp_card_microbe",
     "细菌与病毒的区别",
     "基础科学知识点内容（人话接口）", "微生物学",
     "细菌与病毒的核心区别：①细菌是单细胞生物，有细胞壁和细胞器，可独立代谢"
     "繁殖；病毒无细胞结构，只有核酸+蛋白质外壳，必须寄生在活细胞内才能复制。"
     "②细菌用抗生素（如青霉素）治疗有效；病毒用抗生素无效，需抗病毒药物或靠"
     "免疫系统。③细菌有害有益（肠道菌群帮助消化），病毒绝大多数有害。大小："
     "细菌约 1-5 微米，病毒约 20-300 纳米——病毒比细菌小得多。",
